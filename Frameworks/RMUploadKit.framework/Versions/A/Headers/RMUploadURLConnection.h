 ...
 */
- (void)sendGetRequestWithParameters:(NSDictionary *)params toURL:(NSURL *)url DEPRECATED_ATTRIBUTE;

/*!
	@brief
	This method is deprecated, use <tt>+[NSURLRequest filePostRequestWithParameters:toURL:]</tt> instead.
 */
- (void)sendFilePostRequestWithParameters:(NSArray *)params toURL:(NSURL *)url DEPRECATED_ATTRIBUTE;

/*!
	@brief
	This method is deprecated, use <tt>+[NSURLRequest postRequestWithParameters:toURL:]</tt> instead.
 */
- (void)sendPostRequestWithParameters:(NSDictionary *)params toURL:(NSURL *)url DEPRECATED_ATTRIBUTE;
