...
/*!
	@brief
	An <tt>NSArray</tt> of <tt>NSString</tt> objects representing tags. (<tt>NSArray</tt> of <tt>NSString</tt> objects)
 */
...
/*!
	...
	<tt>RMUploadFileURLKey</tt> : The location of the file to be uploaded on disk. This comes in the form of a URL. (<tt>NSURL</tt>) <br/>
	
	<tt>RMUploadTitleKey</tt> : The title of the file to be uploaded. (<tt>NSString</tt>) <br/>
	
	<tt>RMUploadOriginalDateKey</tt> : This is the date when the image was taken/snapped/modified. For example, in Flickr's "date taken" field you would pass this value. For any APIs requiring the current date of the upload the plugin is required to pass it on however it feels is appropriate. (<tt>NSDate</tt>) <br/>
	
	<tt>RMUploadOriginalURLKey</tt> : If the file is a websnap, this will be passed as the URL of where the websnap was taken. (<tt>NSURL</tt>) <br/>
	
	<tt>RMUploadDescriptionKey</tt> : Any additional comments provided by the user. Such as the "description" field in LittleSnapper. (<tt>NSString</tt>) <br/>
	
	<tt>RMUploadTagsKey</tt> : An <tt>NSArray</tt> of <tt>NSString</tt> objects associated with the file. (<tt>NSArray</tt> of <tt>NSString</tt> objects.) <br/>
*/
